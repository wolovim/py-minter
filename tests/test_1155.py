...
def test_get_uri(acct1, acct2, sbt_1155_contract):
    # sbt_1155_contract.mint(acct2, 1, sender=acct1)
    # assert sbt_1155_contract.totalSupply(1) == 1
    assert sbt_1155_contract.uri(1) == "test"
